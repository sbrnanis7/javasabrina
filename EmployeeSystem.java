...
//         String[] employeenames = new String[5]; //array 5 employee names
//         double[][] employeesalaries = new double[5][3]; // array salary and allowance


//         for(double i = 1; i < employeenames.length; i++) {
//             System.out.println("Enter Employee Name: "); //input name and salary
//             employeenames[i] = scanner.nextLine();

//             System.out.print("Enter Base Salary: ");
//             employeesalaries[i][0] = scanner.nextInt();

//             System.out.print("Enter Health Allowance: ");
//             employeesalaries[i][1] = scanner.nextInt();

//             System.out.print("Enter Transportation Allowance: ");
//             employeesalaries[i][2] = scanner.nextInt();
//             scanner.nextLine();
...
//             employeeBonuses[i] = calculateBonus(totalSalary);
...
//             System.out.println("Base Salary: " + employeesalaries);
//             System.out.println("Total Salary: " + calculateBonus(employeeBonuses[i]));
//             System.out.println("*************************************");
